...
char *ssid = "民大彭于晏";             //填写你的wifi名字
char *password = "nideshengri";        //填写你的wifi密码
char *service_ip = "192.168.31.101";   //上位机IP
int httpPort = 9999;                   //设置上位机端口
...
void setup()
{
    ...
    {
        for (byte n = 0; n < 10; n++)  //每50毫秒检测一次状态
        {
            loading(50);
        }
    }
